             ...
             <div class="row">
                 ...
                 <div class="col-lg-6">
                     <section class="panel">
                         ...
                         <div class="panel-body">
                             <div class="form">
                                 <form accept-charset="utf-32" class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo site_url()?>index.php/tks/insert_employee/">
                                     ...
                                     <div class="form-group ">
                                         ...
                                         <div class="col-lg-10">
                                             ...
                                             <select id="employment_status" name="department" class="form-control m-bot15">
                                     ...
                                     <div class="form-group ">
                                         <label for="firstname" class="control-label col-lg-2">Firsname</label>
                                         <div class="col-lg-10">
                                     ...
                                     <div class="form-group ">
                                         ...
                                         <div class="col-lg-10">
                                             <input class=" form-control" maxlength="48" id="minit" name="minit" type="text" />
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-3 col-xs-11">
                                             <input class="form-control form-control-inline input-medium default-date-picker"  id="date_hired" name="date_hired" size="16" type="text" value="" />
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-3 col-xs-11">
                                             <input class="form-control form-control-inline input-medium default-date-picker"  id="birth_date" name="birth_date" size="16" type="text" value="" />
                                             <span class="help-block">Select date</span>
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group ">
                                         ...
                                         <div class="col-lg-10">
                                             <input maxlength="250" class="form-control " id="address1" name="address1" type="text" />
                                         </div>
                                     </div>
