...
<div id="header" >
    <div class="container">
        <a class="logo" style="float: left;" href<span style="">Ryan Carlo E. Carpio <span style="font-size:10px;">Login & Registration</span></a>
        <div id="login_form">
        ...
        <form action="<?=site_url('user/do_register')?>" method="post">
            ...
            <p>
                <label for="name">Captcha:
                    <input value="<?php if(!empty($userCaptcha)){ echo $userCaptcha;} ?>" id="captcha" name="captcha" type="text" />
                </label>
            </p>
